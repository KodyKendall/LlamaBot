...
# docker buildx build --file Dockerfile --platform linux/amd64,linux/arm64 --tag kody06/llamabot:0.2.6 --push .
# docker buildx build --file Dockerfile --platform linux/amd64 --tag kody06/llamabot:0.1.17 --push .
# docker buildx build --file Dockerfile --platform linux/amd64 --tag kody06/llamabot:0.2.6 --push .
