...
RUN apt-get update && apt-get install -y curl gnupg ca-certificates ripgrep util-linux && \
...
# docker buildx build --file Dockerfile --platform linux/amd64,linux/arm64 --tag kody06/llamabot:0.3.5fa --push .