...
# Tools
@tool
def read_file(file_path: str, state: Annotated[TerminalAgentState, InjectedState]) -> str:
...
@tool
def write_file(file_path: str, content: str, state: Annotated[TerminalAgentState, InjectedState]) -> str:
...
@tool
def list_directory(path: str = "", state: Annotated[TerminalAgentState, InjectedState]) -> str:
...
@tool
def run_command(command: str, working_dir: str = "", state: Annotated[TerminalAgentState, InjectedState]) -> str:
...
@tool
def get_current_directory(state: Annotated[TerminalAgentState, InjectedState]) -> str:
    """Get the current working directory."""
    current_dir = state.get("current_directory", os.getcwd())
    return f"Current directory: {current_dir}"

@tool
def search_files(pattern: str, directory: str = "", state: Annotated[TerminalAgentState, InjectedState]) -> str:
