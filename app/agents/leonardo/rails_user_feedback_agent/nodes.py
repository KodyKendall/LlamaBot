...
def build_workflow(checkpointer=None):
    ...
    builder.add_node("leonardo_user_feedback", leonardo_user_feedback)
    builder.add_node("tools", ToolNode(default_tools))

    # Define edges: these determine how the control flow moves
    builder.add_edge(START, "leonardo_user_feedback")

    builder.add_conditional_edges(
        "leonardo_user_feedback",
        tools_condition,
        {"tools": "tools", END: END},
    )

    builder.add_edge("tools", "leonardo_user_feedback")
